  ...
  <div class="container">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="main-user-info">
        ...
        <div class="user-input-box">
          <input type="text" id="descripcion" name="descripcion" value="<?= $res['descripcion'] ?>" placeholder="Ingrese descripción" />
          <?=$descripcionError?>
        </div>
    ...
    <div class="user-input-boxFile2">
      <input type="file" id="logo_camara" name="logo_camara" value="images/logosCamaras/<?= $res['logo_camara'] ?>"/>
      <img class="imagencapacitador" width="50%" src="images/logosCamaras/<?= $res['logo_camara'] ?>" alt="">
    </div></label>

        <div class="user-input-box">
          <input type="tel" id="telefono" name="telefono" value="<?= $res['telefono'] ?>" placeholder="Ingrese teléfono" />
          <span for="teléfono" class="error"></span>
          <?=$telefonoError?>
        </div>
        <div class="user-input-box">
          <input type="text" id="direccion" name="direccion" value="<?= $res['direccion'] ?>" placeholder="Ingrese dirección" />
          <?=$direccionError?>
        </div>
        <div class="user-input-box">
          <input type="text" id="codigo_postal" name="codigo_postal" value="<?= $res['codigo_postal'] ?>" placeholder="Ingrese código postal" />
          <?=$codigoPostalError?>
        </div>
        <div class="user-input-box">
          <select name="provincia" id="provincia" class="style-select">
            <option value="<?= $res['provincia'] ?>"><?= $res['provincia'] ?></option>
            <?php
        ...
        <div class="user-input-box">
          <input type="text" id="facebook" name="facebook" value="<?= $res['facebook'] ?>" placeholder="Ingrese facebook" />
          <?=$facebookError?>
        </div>
        <div class="user-input-box">
          <input type="text" id="instagram" name="instagram" value="<?= $res['instagram'] ?>" placeholder="Ingrese instagram" />
          <?=$instagramError?>
        </div>
        <?php } ?>
