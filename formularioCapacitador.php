...
if (isset($_POST['aceptar'])) {
  ...
  $consulta = $pdo->prepare('INSERT INTO capacitadores (nombre, apellido, cuil_cuit, imagen, telefono, direccion, codigo_postal, email, empresa, descripcion, provincia) VALUES (:nombre, :apellido, :cuil_cuit, :imagen, :telefono, :direccion, :codigo_postal, :email, :empresa, :descripcion, :provincia)');
  ...
  <div class="container">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="main-user-info">
        ...
        <div class="user-input-box">
        <input type="text" name="empresa" value="<?php if (isset($empresa)) echo $empresa ?>" placeholder="Ingrese empresa capacitadora" />
        <?=$empresaError?>
        </div>
        </div>
